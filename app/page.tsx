    ...
    <div className='min-h-screen bg-[#FAF6F0] text-[#2D241E] selection:bg-[#78350F] selection:text-white flex flex-col justify-between'>
      ...
      <main className='flex-grow'>
        ...
        <section className='py-20 bg-[#FAF6F0] text-[#2D241E] border-b border-amber-900/10'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center max-w-2xl mx-auto mb-16'>
              ...
              <h2 className='font-serif text-3xl sm:text-4xl font-extrabold text-[#4A2E1A] mt-2 leading-tight'>
                Ciepłe Słowa Znad Talerza
              </h2>
              <p className='text-sm text-amber-950/70 mt-3 leading-relaxed'>
                Największą nagrodą za naszą ciężką pracę są uśmiechnięte twarze
                gości i puste talerze wracające do zmywaka. Oto kilka opinii.
              </p>
            </div>
              ...
              {testimonials.map((t, idx) => (
                ...
                >
                  ...
                  <div className='flex items-center gap-3 pt-6 mt-6 border-t border-amber-900/5'>
                    ...
                    <div>
                      <h4 className='font-bold text-sm text-[#4A2E1A]'>
                        {t.name}
                      </h4>
                      <p className='text-[10px] text-amber-950/50 uppercase tracking-wider font-semibold'>
                        {t.role}
                      </p>
                    </div>
                  </div>
        ...
        {user && userRole === "admin" && showAdminPanel && (
          <section
            ...
            className='py-20 bg-[#FAF6F0] border-b border-amber-900/10'
          >
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              <AdminDashboard />
            </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left'>
              ...
              <div className='bg-white p-6 rounded-2xl border border-amber-900/5 shadow-sm space-y-3'>
                ...
                <h4 className='font-serif font-bold text-lg text-[#4A2E1A]'>
                  Gdzie jesteśmy?
                </h4>
              ...
              <div className='bg-white p-6 rounded-2xl border border-amber-900/5 shadow-sm space-y-3'>
                ...
                <span className='text-[10px] text-amber-900/50 uppercase tracking-widest font-extrabold'>
                  Kuchnia przyjmuje do 21:30
                </span>
              </div>
              ...
              <div className='bg-white p-6 rounded-2xl border border-amber-900/5 shadow-sm space-y-3'>
                ...
                <p className='text-sm text-amber-950/85'>
                  Telefon: <span className='font-bold'>+48 501 202 303</span>{" "}
                  <br />
                ...
                <div className='flex justify-center md:justify-start gap-3 pt-1'>
                  <a
                    href='#'
                    className='p-1.5 hover:bg-amber-900/5 rounded-lg text-[#78350F] transition'
                    aria-label='Facebook'
                  >
                    <Facebook size={18} />
                  </a>
      ...
      <footer className='bg-[#4A2E1A] text-amber-100/60 py-8 border-t border-amber-950 text-center text-xs font-semibold tracking-wide'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-2'>
          <p>
            © {new Date().getFullYear()} Babcia Gotuje. Wszystkie prawa
            zastrzeżone.
          </p>
          <p className='text-[10px] opacity-65'>
            Smaczna i prawdziwa kuchnia polska serwowana prosto z serca Babci
            Marysi.
          </p>
        </div>
      </footer>
