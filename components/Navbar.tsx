          ...
          <div className='flex items-center gap-3'>
            <a href='#' className='flex items-center gap-2 group'>
              ...
              <div className='flex flex-col'>
                ...
                <span className='text-[10px] uppercase tracking-widest text-amber-900/60 font-bold'>
                  Prawdziwy Smak Domu
                </span>
              </div>
            </a>
                    ...
                    <>
                      ...
                      <div className='absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-amber-900/10 py-2.5 z-20 text-[#2D241E]'>
                        <div className='px-4 py-2 border-b border-amber-900/5 mb-2'>
                          <p className='text-xs text-amber-950/50 uppercase tracking-widest font-bold'>
                            Witaj, wnuczku!
                          </p>
                          <p className='text-sm font-bold text-[#4A2E1A] truncate mt-0.5'>
                            {user.displayName || "Klient"}
                          </p>
                          <p className='text-[11px] text-amber-950/60 truncate'>
                            {user.email}
                          </p>
                        </div>
          ...
          <>
            ...
            >
              <div className='flex items-center justify-between px-5 py-4 border-b border-amber-900/10'>
                <div>
                  <p className='text-xs uppercase tracking-[0.25em] text-amber-900/60 font-bold'>
                    Szybkie Menu
                  </p>
                  <p className='text-base font-semibold text-[#4A2E1A]'>
                    Babcia Gotuje
                  </p>
                </div>
                <button
              ...
              <div className='px-5 py-6 space-y-6'>
                ...
                <div className='bg-white rounded-3xl border border-amber-900/10 p-4 shadow-sm'>
                  <div className='flex items-center justify-between mb-4'>
                    <div>
                      <p className='text-xs uppercase tracking-[0.2em] text-amber-900/50 font-bold'>
                        Twoje konto
                      </p>
                      <p className='text-base font-semibold text-[#4A2E1A]'>
                        {user ? user.displayName || "Konto" : "Gość"}
                      </p>
                    </div>
                    <div className='text-sm text-[#78350F] font-bold'>
                      {cartItemsCount}+
                    </div>
                  </div>
                  {user ? (
